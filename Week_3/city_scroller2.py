...
class Scroller(object):
    ...
    def draw_buildings(self):
        for building in self.build_list:
            building.draw(self.combined_width)
    ...
    def move_buildings(self):
        ...
        if self.build_list[0].x < 0:
            ...
            x_location = self.build_list[-1].x + width
            building = Building(x_location, self.height, width, random.randint(-400, -80),  self.color)
            self.build_list.insert(800, building)
...
front_scroller = Scroller(SCREEN_WIDTH, 450, SCREEN_HEIGHT, FRONT_SCROLLER_COLOR, -3)
middle_scroller = Scroller(SCREEN_WIDTH, 450, (SCREEN_HEIGHT - 50), MIDDLE_SCROLLER_COLOR, -2)
back_scroller = Scroller(SCREEN_WIDTH, 450, (SCREEN_HEIGHT - 100), BACK_SCROLLER_COLOR, -1)

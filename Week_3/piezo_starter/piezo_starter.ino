...
//intro
//  tone(PIEZOPIN, note_C4, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_C5, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_C4, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_C5, eighth_note);
...
//  tone(PIEZOPIN, note_B4, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_G4, half_note + quarter_note);
//  delay(half_note + quarter_note);
//  tone(PIEZOPIN, note_E4, quarter_note);
//  delay(quarter_note);
//  tone(PIEZOPIN, note_D4, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_C4, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_C5, eighth_note);
...
//  tone(PIEZOPIN, note_B4, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_G4, eighth_note + quarter_note);
//  delay(eighth_note + quarter_note);
//  tone(PIEZOPIN, note_C4, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_G4, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_C4, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_E4, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_F4, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_E4, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_C4, eighth_note);
...
//  tone(PIEZOPIN, note_G4, half_note + quarter_note);
//  delay(half_note + quarter_note);
//  tone(PIEZOPIN, note_D4, quarter_note);
//  delay(quarter_note);
//  //lyrics
//  tone(PIEZOPIN, note_G4, eighth_note);
//  delay(eighth_note);
...
//  tone(PIEZOPIN, note_G4, eighth_note);
//  delay(eighth_note);
//  tone(PIEZOPIN, note_G4, quarter_note);
//  delay(quarter_note);
//  tone(PIEZOPIN, note_D4, quarter_note);
//  delay(quarter_note);
//

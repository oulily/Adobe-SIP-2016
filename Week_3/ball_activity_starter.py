...
while not done:
    ...
    # --- Drawing code should go here
    ball_c = random.choice(possible_ball_colors) # This is outside because of variable scoping.


    # Ball 2 
    pygame.draw.circle(screen, ball_c, [x_loc, y_loc], ball_s)


    if x_loc >= SCREEN_WIDTH - ball_s or x_loc < ball_s:
        x_s = x_s * -1

    if y_location >= SCREEN_HEIGHT - ball_s or y_loc < ball_s:
        y_s = y_s * -1
